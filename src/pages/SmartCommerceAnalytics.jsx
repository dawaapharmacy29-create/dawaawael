...
const SmartCommerceDailyChart = lazy(() => import("@/components/analytics/SmartCommerceDailyChart"));
...
export default function SmartCommerceAnalytics() {
  ...
  return <div dir="rtl" className="p-4 md:p-6 space-y-6">
    ...
    <Suspense fallback={<Card className="p-8 text-center text-sm text-gray-400">جاري تحميل الرسم اليومي...</Card>}>
      <SmartCommerceDailyChart data={dailyComparison} avg3Sales={avg3Sales} elapsedDays={elapsedDays} />
    </Suspense>
