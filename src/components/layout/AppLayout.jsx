...
const navItems = [
  ...
  { path: "/supplier-balances-shokry", label: "أرصدة دواء شكري", icon: HandCoins, indent: true, section: "suppliers" },
  { path: "/supplier-balances-shami", label: "أرصدة دواء الشامي", icon: HandCoins, indent: true, section: "suppliers" },
